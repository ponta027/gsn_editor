 ...
 * </p>
 * <ul>
 *   <li>{@link GSN.impl.AwaySolutionImpl#getPointsTo <em>Points To</em>}</li>
 *   <li>{@link GSN.impl.AwaySolutionImpl#getModuleIdentifier <em>Module Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AwaySolutionImpl extends SpinalElementImpl implements AwaySolution {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.AWAY_SOLUTION;
	}
		...
		if (pointsTo != null && pointsTo.eIsProxy()) {
			...
			if (pointsTo != oldPointsTo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.AWAY_SOLUTION__POINTS_TO, oldPointsTo, pointsTo));
			}
		}
		return pointsTo;
	}
	...
	public void setPointsTo(Solution newPointsTo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AWAY_SOLUTION__POINTS_TO, oldPointsTo, pointsTo));
	}
	...
	public void setModuleIdentifier(String newModuleIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.AWAY_SOLUTION__MODULE_IDENTIFIER, oldModuleIdentifier, moduleIdentifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.AWAY_SOLUTION__POINTS_TO:
				if (resolve) return getPointsTo();
				return basicGetPointsTo();
			case ModelPackage.AWAY_SOLUTION__MODULE_IDENTIFIER:
