 ...
 * </p>
 * <ul>
 *   <li>{@link GSN.impl.ModelElementImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link GSN.impl.ModelElementImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link GSN.impl.ModelElementImpl#getContainsAdditional <em>Contains Additional</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ModelElementImpl extends MinimalEObjectImpl.Container implements ModelElement {
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MODEL_ELEMENT__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public EList<TaggedValue> getContainsAdditional() {
		if (containsAdditional == null) {
			containsAdditional = new EObjectContainmentEList<TaggedValue>(TaggedValue.class, this, ModelPackage.MODEL_ELEMENT__CONTAINS_ADDITIONAL);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.MODEL_ELEMENT__CONTAINS_ADDITIONAL:
