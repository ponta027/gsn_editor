 ...
 * </p>
 * <ul>
 *   <li>{@link GSN.impl.SolutionImpl#getVisibility <em>Visibility</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SolutionImpl extends SpinalElementImpl implements Solution {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SOLUTION;
	}
	...
	public void setVisibility(ElementVisibility newVisibility) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SOLUTION__VISIBILITY, oldVisibility, visibility));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.SOLUTION__VISIBILITY:
