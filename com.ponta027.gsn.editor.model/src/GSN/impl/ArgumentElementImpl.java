 ...
 * </p>
 * <ul>
 *   <li>{@link GSN.impl.ArgumentElementImpl#getTobeinstantiated <em>Tobeinstantiated</em>}</li>
 *   <li>{@link GSN.impl.ArgumentElementImpl#getIsPartOf <em>Is Part Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ArgumentElementImpl extends ModelElementImpl implements ArgumentElement {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.ARGUMENT_ELEMENT;
	}
	...
	public void setTobeinstantiated(Boolean newTobeinstantiated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ARGUMENT_ELEMENT__TOBEINSTANTIATED, oldTobeinstantiated, tobeinstantiated));
	}
	...
	public Module getIsPartOf() {
		if (isPartOf != null && isPartOf.eIsProxy()) {
			...
			if (isPartOf != oldIsPartOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.ARGUMENT_ELEMENT__IS_PART_OF, oldIsPartOf, isPartOf));
			}
		}
		return isPartOf;
	}
	...
	public NotificationChain basicSetIsPartOf(Module newIsPartOf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.ARGUMENT_ELEMENT__IS_PART_OF, oldIsPartOf, newIsPartOf);
	...
	public void setIsPartOf(Module newIsPartOf) {
		if (newIsPartOf != isPartOf) {
			...
			if (isPartOf != null)
				msgs = ((InternalEObject)isPartOf).eInverseRemove(this, ModelPackage.MODULE__CONTAINS_ELEMENT, Module.class, msgs);
			if (newIsPartOf != null)
				msgs = ((InternalEObject)newIsPartOf).eInverseAdd(this, ModelPackage.MODULE__CONTAINS_ELEMENT, Module.class, msgs);
			msgs = basicSetIsPartOf(newIsPartOf, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ARGUMENT_ELEMENT__IS_PART_OF, newIsPartOf, newIsPartOf));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.ARGUMENT_ELEMENT__IS_PART_OF:
				if (isPartOf != null)
					msgs = ((InternalEObject)isPartOf).eInverseRemove(this, ModelPackage.MODULE__CONTAINS_ELEMENT, Module.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.ARGUMENT_ELEMENT__TOBEINSTANTIATED:
